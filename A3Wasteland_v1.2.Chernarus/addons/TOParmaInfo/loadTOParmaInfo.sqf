...
_serverInfoString = format ["<t color='#A0FFFF'>NYC Wasteland #%1 %2 Wasteland</t>", call A3W_extDB_ServerID, worldName];
...
_generalInfoString = "Website: <t color='#0091CD'><a href='http://www.nycwasteland.com/'>Cuntee`s NYC Wasteland</a></t>";
_generalInfoText ctrlSetStructuredText parseText _generalInfoString;


_rulesOnline = "http://chos.site.nfoservers.com/rules/";
_rulesOffline = "addons\TOParmaInfo\rules.html";
//_newsOnline = "http://chos.site.nfoservers.com/forums/";
