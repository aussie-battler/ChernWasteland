...
[
	["Vehicles",true],
		["Motorcycle", [2],  "", -5, [["expression", format[_EXECscript5,"ATV.sqf"]]], "1", "1"],
		["SUV Minigun", [3],  "", -5, [["expression", format[_EXECscript5,"strider.sqf"]]], "1", "1"],
		["Pawnee", [4],  "", -5, [["expression", format[_EXECscript5,"pawnee.sqf"]]], "1", "1"],
		["Hatchback Sport", [5], "", -5, [["expression", format[_EXECscript5,"hatchback.sqf"]]], "1", "1"],
		["Marshall", [6], "", -5, [["expression", format[_EXECscript5,"marshall.sqf"]]], "1", "1"],
		["Apache", [7], "", -5, [["expression", format[_EXECscript5,"blackfoot.sqf"]]], "1", "1"],
		["A-10", [8], "", -5, [["expression", format[_EXECscript5,"a10.sqf"]]], "1", "1"],
