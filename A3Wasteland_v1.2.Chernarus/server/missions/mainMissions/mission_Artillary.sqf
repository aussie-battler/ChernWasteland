...
_setupObjects =
{
	...
	_missionHintText = format ["A mobile artillary tank is being escorted by two armed vehicles. Stop them!", _vehicleName, mainMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "The artillary convoy has been stopped! The tank and vehicles are now yours to take.";
};
