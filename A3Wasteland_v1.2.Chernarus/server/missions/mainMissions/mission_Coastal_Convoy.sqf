...
_setupObjects =
{
	...
	_vehChoices =
	[
		["B_Boat_Armed_01_minigun_F", "CUP_B_UH1Y_GUNSHIP_F"],
	...
	{
		(_vehChoices select 0) set [1, "CUP_B_AH1Z_AT"];
		(_vehChoices select 1) set [1, "CUP_B_AH64D_USA"];
		(_vehChoices select 2) set [1, "CUP_B_UH1Y_GUNSHIP_F"];
	};
	...
	_createVehicle =
	{
		...
		switch (true) do
		{
			...
			case (_type isKindOf "CUP_B_UH1Y_GUNSHIP_F"):
			{
