...
//	@file Author: JoSchaap, AgentRev, LouD, Cuntee`
...
_setupObjects =
{
	...
	_convoyVeh = ["CUP_RG31_M2","CUP_B_M1A1_Woodland_USMC","CUP_B_M163_USA","CUP_B_T72_CDF","CUP_B_Jackal2_GMG_GB_W"];
	...
	_missionHintText = format ["A convoy containing at least a <t color='%4'>%1</t>, a <t color='%4'>%2</t> and a <t color='%4'>%3</t> is patrolling Chernarus! Stop the patrol and capture the goods and money!", _vehicleName, _vehicleName2, _vehicleName3, moneyMissionColor];
