...
_setupObjects =
{
	...
	{
		["CUP_B_AH64D_USA", "CUP_B_Mi24_D_CDF"] call BIS_fnc_selectRandom;
	}
	else
	{
	...
	_createVehicle =
	{
		...
		switch (true) do
		{
			...
			case (_type isKindOf "CUP_B_AH64D_USA" || _type isKindOf "CUP_B_Mi24_D_CDF"):
			{
	...
	_missionHintText = format ["An armed <t color='%2'>%1</t> is patrolling Chernarus. Intercept it and recover its cargo!", _vehicleName, sideMissionColor];
