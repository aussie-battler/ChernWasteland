...
_setupObjects =
{
	...
	_missionHintText = format ["An armed <t color='%2'>%1</t> is patrolling Chernarus. Shoot it down and kill the pilot to recover the money and weapons!", _vehicleName, sideMissionColor];
